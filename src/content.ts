...
export const content = {
  ...
  contact: {
    ...
    form: {
      ...
      meetLabel: "How would you like to meet?",
      meetOptions: ["In person", "Online"],
      locatedLabel: "Where are you located?",
      locatedPlaceholder: "e.g. Upper West Side, Williamsburg, East Hampton",
